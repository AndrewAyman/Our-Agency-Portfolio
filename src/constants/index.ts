...
export const PORTFOLIO = [
  {
    ...
    region: "KSA",
    sector: "Construction",
    title: "Construction & Engineering Brands — KSA",
    desc: "We ran performance-driven ad campaigns for construction companies and engineering consultancies, targeting serious B2B clients — resulting in significantly increased sales inquiries and higher demand.",
    result: "+Sales Demand",
  ...
  },
  {
    ...
    region: "KSA",
    sector: "Branding",
    title: "Saudi Brand Visual Identities",
    desc: "Built complete visual identity systems for Saudi brands from scratch — covering logos, visual guidelines, content tone of voice, and full brand documentation ready for investor presentations.",
  ...
  },
  {
    ...
    region: "KSA",
    sector: "Paid Ads",
    title: "1,000,000+ Impressions Campaign — KSA",
    desc: "Managed high-performance paid ad campaigns in the Saudi market that exceeded 1,000,000 impressions in a short period — targeting the right audience with professional, trust-building creative.",
  ...
  },
  {
    ...
    desc: "We managed awareness-focused social accounts for doctors and clinics, produced Before/After content and patient experience stories, and ran targeted ad campaigns that generated real appointment bookings and leads.",
    result: "Real Leads",
  ...
  },
  {
    ...
    region: "Egypt",
    sector: "Podcast",
    title: "Podcast & Media Show Production — Egypt",
    desc: "Full-service podcast production: concept design, visual identity, comprehensive episode and guest management, professional editing, Reels & Shorts, and social media growth strategy.",
  ...
  },
  {
    ...
    desc: "Built compelling visual identities and produced professional food photography and video. Managed entertainment + sales content that increased engagement, and ran marketing campaigns that directly drove up orders and revenue.",
    result: "+Orders & Sales",
